...
/**
 * TransformableEllipse component
 * An ellipse shape that can be selected, moved, resized, and rotated
 */
const TransformableEllipse = ({
  shapeProps,
  isSelected,
  onSelect,
  onChange
    ...
    <>
      <Ellipse
        ...
        onTransformEnd={() => {
          ...
          // Reset the scale to 1 (we'll apply it to radiusX/radiusY instead)
          node.scaleX(1);
          node.scaleY(1);
...
TransformableEllipse.propTypes = {
...
export default TransformableEllipse;
